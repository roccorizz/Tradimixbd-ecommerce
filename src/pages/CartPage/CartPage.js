                    ...
                    <div className='cart-cfoot flex align-start justify-between py-3 bg-white'>
                        ...
                        <div className='cart-cfoot-r flex flex-column justify-end'>
                            <div className='total-txt flex align-center justify-end'>
                                <div className='font-monrope fw-5'>Total {itemsCount} items: </div>
                                <span className='text-purple fs-22 mx-2 fw-6 '>{formatPrice(totalAmount)}</span>
                            </div>
                            <button type="button" className='checkout-btn text-white bg-purple fs-16'>Check Out</button>
                        </div>
                    </div>
                </div>
            </div>
